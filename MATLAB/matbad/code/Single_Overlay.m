...
dataset_files  = {'data/dde_batch_0.2_0.0_eps_0.1_20.mat'};
...
dataset_colors = [0.0 0.3 0.8;];   % psi=2.86  → deep purple
...
title('Stability map in $(\Omega, \tau_1)$ plane for $\tau_0=0.2$ and $\varepsilon=0.1$', ...
      'FontSize', 14, ...
      'Color', 'k', ...
      'Interpreter', 'latex');
%ax.XTick = 0:1:10;
...
exportgraphics(gcf, 'LONG_stability_map_0_01_20.png', 'Resolution', 300, 'BackgroundColor', 'white');
